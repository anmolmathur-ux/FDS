...
export default function Home() {
      ...
      <section className="w-full h-[100vh] relative px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
        ...
        <div className="relative z-10 flex items-center justify-center h-full">
          <div className="max-w-6xl text-center">
            ...
            {/* Stats */}
            <ul className=" mt-6 flex justify-center flex-wrap text-white gap-3 sm:gap-5 md:gap-8 text-xs sm:text-sm md:text-base px-4 sm:px-6 md:px-8 " > <li className="flex items-center">
  <svg
  ...
  <strong className="mr-1">6</strong>
  Core Subject Areas
</li>
<li className="flex items-center">
  ...
  <strong className="mr-1">Self-Paced</strong>
  Modules
</li>
...
<li className="flex items-center">
  ...
  <strong className="mr-1">Community</strong>
  Support
</li>
